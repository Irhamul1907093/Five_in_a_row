...
class MinimaxNode:
    ...
    def generate_child_nodes(self):
        ...
        """
        possible_moves = State.generate_possible_moves(self.board, ai_setup.EXPANSION_RANGE)
        child_nodes = []
        for move in possible_moves:
            child_node = MinimaxNode(self.board, move, game_setup.get_opponent(self.current_turn), None)

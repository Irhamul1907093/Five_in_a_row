...
# SET X AND O COLOR
X_COLOR = COLOR_DARK_GREEN
O_COLOR = COLOR_PURPLE
O_LAST_MOVE_COLOR = COLOR_ORANGE
X_LAST_MOVE_COLOR = COLOR_ORANGE

def get_last_move_color(player):
    if (player == game_setup.O):
        return O_LAST_MOVE_COLOR
    if (player == game_setup.X):
...
BOARD_WIDTH = game_setup.BOARD_COL_COUNT * SQUARE_SIZE
BOARD_HEIGHT = game_setup.BOARD_ROW_COUNT * SQUARE_SIZE
